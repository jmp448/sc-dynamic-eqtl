...
emp_pvals <- empPvals(observed_tests$t.unadj, perm_tstats, pool=F)
...
write_tsv(results, paste0("../results/eqtl_dynamic/linear_dQTL/permuted_cells/", dataset, "/", agg, "/sample-", perm_sample, "/", cis.dist, "-", n.cl.pcs, "clpcs-", n.samp.pcs, "pcs-", cell.type.reg, ".mtc.tsv"))
write_tsv(top.hits, paste0("../results/eqtl_dynamic/linear_dQTL/permuted_cells/", dataset, "/", agg, "/sample-", perm_sample, "/", cis.dist, "-", n.cl.pcs, "clpcs-", n.samp.pcs, "pcs-", cell.type.reg, ".tophits.tsv"))

...
qtl_files <- paste0("../results/eqtl_dynamic/nonlinear_dQTL/", dataset, "/", agg, "/t_test/", cis.dist, "-", n.cl.pcs, "clpcs-", n.samp.pcs, "pcs-", cell.type.reg, "-", seq(1, chunks_tot), ".tsv")
...
# run ashr
betahat <- results$beta.gxt2
sehat <- results$stdev.unscaled.gxt2 * sqrt(results$s2.post)
...
saveRDS(g, paste0("../results/eqtl_dynamic/nonlinear_dQTL/", dataset, "/", agg, "/t_test/", cis.dist, "-", n.cl.pcs, "clpcs-", n.samp.pcs, "pcs.ashr.g.rds"))
...
write_tsv(results, paste0("../results/eqtl_dynamic/nonlinear_dQTL/", dataset, "/", agg, "/t_test/", cis.dist, "-", n.cl.pcs, "clpcs-", n.samp.pcs, "pcs-", cell.type.reg, ".mtc.tsv"))
write_tsv(top.hits, paste0("../results/eqtl_dynamic/nonlinear_dQTL/", dataset, "/", agg, "/t_test/", cis.dist, "-", n.cl.pcs, "clpcs-", n.samp.pcs, "pcs-", cell.type.reg, ".tophits.tsv"))

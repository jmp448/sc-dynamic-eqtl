...
```{r}
my_cols <- c("#0077BB", "#70d1d0", "#117733", "#BF0202", "#9640CE")
```
...
fig2b <- FeaturePlot(sc_cardiac, "pseudotime", reduction="fa", cols=viridis_pal()(100)) + 
  theme(title=element_text(size=0), axis.title=element_text(size=20), 
        legend.text=element_text(size=15), legend.title=element_text(size=20))
```
...
png('figs/fig2/fig2.png', width=800, height=800)
plot(fig2)
dev.off()
```
![](../figs/fig2/fig2.png)
...
annotate_hits <- function(epi, celltype) {
  read_tsv(paste0("results/epigenetics/linear_dQTL/pseudobulk/", celltype, "bin/50k-5clpcs-5pcs.", epi, ".bed"), col_names=F) %>%
...
cm_hits <- read_tsv("results/eqtl_dynamic/linear_dQTL/pseudobulk/cmbin/50k-5clpcs-5pcs.sighits.bed")

epdc_hits <- read_tsv("results/eqtl_dynamic/linear_dQTL/pseudobulk/epdcbin/50k-5clpcs-5pcs.sighits.bed")
```
